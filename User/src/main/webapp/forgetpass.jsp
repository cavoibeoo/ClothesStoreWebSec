                    ...
                    <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <form action="email" method="post">
                            ...
                            <div class="card-body userbox">
                                ...
                                <label for="recover-email" class="icon-field"><i class="icon-login icon-envelope "></i></label>
                                <input type="text" size="30" name="email" placeholder="Email" id="recover-email">
                            </div>
